  ...
  return (
    <div className=" relative">
      <div className="flex items-center gap-3">
        ...
        py-3 px-4 rounded-full transition hover:bg-neutral-100 cursor-pointer"
        >
          Airbnb your home
        </div>
        <div
      ...
      {isOpen && (
        <div
          className=" absolute rounded-xl shadow-md w-[40vw] md:w3/4
        bg-white overflow-hidden right-0 top-12 text-sm"
        >
          <div className="flex flex-col cursor-pointer">
            <>
              <MenuItems label="Login" onClick={() => {}} />
              <MenuItems label="SignUp" onClick={() => {}} />
            </>
          </div>
        </div>
      )}
